...
/* create timeline */
    ...
    // create list of all image files for preloading
        ...
        var welcome_block = {
                ...
                html += "<p style='text-align:center;'>   গবেষণার সময় দয়া করে অন্য কোনও কার্যক্রম থেকে বিরত থাকুন   <br><br>    <br>  </p>";
                html += " <p style='text-align:center; font-weight: 750;'>  গবেষণা শুরু করতে পরবর্তী পেজ টিপুন    <br><br>   <br><br>  <br>  </p>";                
                return html;
            },
                choices : ['পরবর্তী  পেজ  '] , 
  ...
  var preform = {
    ...
    var welcome = {
      ...
      stimulus: function(){ 
                ...
                html += "<br><br><p style='text-align:center; font-size:20px;'>   <b>  গবেষণা শুরু করতে পরবর্তী টিপুন    <br><br>   <br><br>  <br>  </p>";
    ...
    var target = {
            type: 'html-button-response',
            stimulus: function(){ 
                var html = "<p style='text-align:center; font-weight: 550; font-size:40px;'>"+jsPsych.timelineVariable('t_sentence', true)+"<br></p>";
    ...
    var feedback = {
            type: 'html-keyboard-response',
            stimulus: function() {
                var feedback_text = '<span style="color:red;font-size:40px;"> ভুল  </span>';
    ...
    var Main_msg = {
      ...
      stimulus: "<p style='font-size:40px'> সার্ভে  <br><br><br></p>"    + 
                "<p style='font-size:30px'> বাক্যটা ছবিটাকে সঠিকভাবে বর্ণনা করছে কি?   <br>   <br><br></p>   <p stlye='font-size:22px;'> আমরা আপনার স্বতঃস্ফূর্ত প্রতিক্রিয়া জানতে উৎসাহী। অনেক বেশি সময় ধরে চিন্তা করে বা আলোচনা করে উত্তর দেবার প্রয়োজন নেই। <br><br><br>  </p>",
      choices: ['পরবর্তী  পেজ  '],  
    };
    ...
    var end_screen = {
            type: 'html-button-response',
            stimulus: "<p style='font-size:30px'>  আমাদের গবেষণা এখানে শেষ হল   <br> <br> পরবর্তী  পেজে     আপনার থেকে  আমরা  কিছু ন্যূনতম    তথ্য সংগ্রহ করবো   <br><br><br><br>  </p>",
          ...
          '<div class="container" style="width:55em">' +
              ...
              '<div class="navigation"> <h2></h2>  </div>'+
                  ...
                  '<div class="info">'+
                    ...
                    '<div class="input">'+
                      '<input type="email" size="16"  placeholder=" gmail "  required="true" name="email" >  ' +
                    '</div>' +
